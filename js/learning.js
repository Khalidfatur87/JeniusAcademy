...
const javaCourse = document.querySelector(".jav-course");
...
const javaCourses = document.querySelectorAll(".course.jav");

const allCourses = [htmlCourses, cssCourses, jsCourses, javaCourses];
